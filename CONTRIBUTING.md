...
some other ruleset that depends on rules_pkg, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_pkg=$(pwd)/rules_pkg"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_pkg` on your system will point to this folder.
